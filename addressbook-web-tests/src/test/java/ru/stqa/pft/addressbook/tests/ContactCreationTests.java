...
public class ContactCreationTests extends TestBase {
  ...
  public void testContactCreation() {
    ...
    app.getContactHelper().fillContactForm(new ContactDataFIO("Petr", "Petrovich", "Ivanov", "ivanov1987"),
                    ...
                    new ContactDataEmailHomepage("mail1@mail.ru", "mail2@rambler.ru", "mail3@nxt.ru", "http://vk.com/ivanov_petr"),
